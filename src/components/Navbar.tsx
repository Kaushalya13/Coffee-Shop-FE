    ...
    return (
        <nav className="fixed top-0 left-0 w-full bg-white/70 backdrop-blur-lg text-black py-4 px-10 flex justify-between items-center shadow-lg z-50">
            ...
            <div className="flex space-x-10 text-lg font-semibold">
                <Link to="/" className="flex items-center gap-2 hover:text-[#a77d51] transition">
                    <FaHome /> Home
                </Link>
                <Link to="/shopPage" className="flex items-center gap-2 hover:text-[#a77d51] transition">
                    <FaShoppingCart /> Shop
                </Link>
                <Link to="/aboutUsPage" className="flex items-center gap-2 hover:text-[#a77d51] transition">
                    <FaInfoCircle /> About Us
                </Link>
                <Link to="/contactUsPage" className="flex items-center gap-2 hover:text-[#a77d51] transition">
                    <FaPhoneAlt /> Contact
                </Link>
            </div>
        </nav>
