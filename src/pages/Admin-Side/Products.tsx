...
import { deleteProduct, fetchProducts, toggleProductStatus } from "../../services/productService";
...
const Products = () => {
    ...
    const [productToDelete, setProductToDelete] = useState<string | null>(null);  // Store product to delete
